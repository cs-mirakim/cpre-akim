...
<body class="bg-slate-50 dark:bg-zinc-950 text-slate-800 dark:text-zinc-100 font-sans antialiased min-h-screen pb-24 md:pb-12 transition-colors duration-150 selection:bg-indigo-500/20">
          ...
          <article id="q-card-\${q.id}" class="q-card bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800/90 rounded-xl p-4 sm:p-5 shadow-sm transition-all hover:border-slate-300 dark:hover:border-zinc-700">
            ...
            \${isRevealed ? \`
              <div class="mt-4 pt-3.5 border-t border-slate-100 dark:border-zinc-800 space-y-3">
                ...
                <!-- Official Answer Strip -->
                <div class="flex items-center justify-between p-2.5 rounded-lg bg-slate-100 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700/70">
                  <div class="text-xs flex items-center gap-2">
                    <span class="text-slate-600 dark:text-zinc-400 font-bold uppercase text-[11px]">Jawapan Rasmi:</span>
                    <span class="font-mono font-extrabold text-slate-900 dark:text-white bg-white dark:bg-zinc-900 px-2.5 py-1 rounded text-xs border border-slate-200 dark:border-zinc-700 shadow-xs">
                      \${q.correctDisplay || 'Rujuk Pilihan di Atas'}
                    </span>
                  </div>
                  <button id="exp-toggle-btn-\${q.id}" onclick="toggleExplanation(\${q.id})" class="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline">
